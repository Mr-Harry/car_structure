...
beeline -u "jdbc:hive2://dz-hadoop-dn2:2181,dz-hadoop-dn3:2181,dz-hadoop-dn4:2181/;serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2" -e "
...
(
    c_id String COMMENT 'msg的simhash编码',
    row_key String COMMENT '唯一编码',
    mobile_id String COMMENT 'id',
    app_name String COMMENT '清洗签名',
    suspected_app_name String COMMENT '原始签名',
